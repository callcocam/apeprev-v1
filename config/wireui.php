...
return [
    ...
    */
    ...
    'components' => [
        ...
        'cnpj' => [
            'class' => App\View\Components\TallCnpjMaskableInput::class,
            'alias' => 'tall.cnpj',
        ],
        'cpf' => [
            'class' => App\View\Components\TallCpfMaskableInput::class,
            'alias' => 'tall.cpf',
        ],
        'whatsapp' => [
            'class' => App\View\Components\TallWhatsAppMaskableInput::class,
            'alias' => 'tall.whatsapp',
        ],
        'input' => [
