                                    ...
                                    <thead class="block md:table-header-group">
                                        <tr
                                            ...
                                            <th
                                                ...
                                                @if ($this->validarLote())
                                                    <x-toggle wire:click="selectCheckboxAll()"
                                                        wire:model.defer="checkboxAll" lg />
                                                @endif
                                            </th>
                                            <th
                                                class="bg-gray-600 p-2 text-white font-bold md:border md:border-grey-500 text-left block md:table-cell">
                                                    ...
                                                    <tr>
                                                        <td colspan="6">
                                                            <div
                                                                ...
                                                                <x-button wire:click="gerarLote" spinner="gerarLote"
                                                                    primary label="GERAR EM LOTE" />
                                                            </div>
                                                        </td>
                                                    </tr>
                                                @endif
                                                            ...
                                                            <div class="md:col-span-2 mt-4 text-right">
                                                                <div class="inline-flex items-end">
                                                                    <span
                                                                        ...
                                                                        <span class="relative">VALOR TOTAL DO(S)
                                                                            CRÉDITOS
