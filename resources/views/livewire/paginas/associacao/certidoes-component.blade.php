        ...
        <div class="rounded-md flex items-center">
            <div class="flex flex-col text-gray-800 text-center sm:text-left w-full">
                ...
                <section class="flex flex-col w-full">
                    <!-- BEGIN: breadcrums v1 -->
                    <x-breadcrums> Certidões</x-breadcrums>
                    <!-- END: breadcrums v1 -->
                </section>
            </div>
        </div>
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="mt-1 flex flex-col sm:flex-row sm:flex-wrap sm:mt-0 sm:space-x-6">
                                <div class="mt-2 flex items-center text-sm text-gray-500">
                                    ...
                                    {{ __('Data emissão') }}: {{ date_carbom_format($model->data_emissao)->format('d/m/Y') }} @if ($model->data_validade)
                                    | {{ __('Data validade') }}: {{ date_carbom_format($model->data_validade)->format('d/m/Y') }}
                                    @endif
                                </div>
                            </div>
                        </div>
