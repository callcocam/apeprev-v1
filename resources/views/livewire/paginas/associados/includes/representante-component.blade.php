        ...
        <form wire:submit.prevent="save" class="lg:col-span-2">
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
                <div class="md:col-span-6">
                    <x-input wire:model.defer="data.name" label="Nome do representante" placeholder="Nome do representante" />
                </div>
                <div class="md:col-span-6">
                ...
                <div class="md:col-span-6">
                    ...
                    wire:model.defer="data.data_nascimento" label="Data Nasc." placeholder="XX/XX/XXXX" />
                </div>
                ...
                <div class="md:col-span-2">
                    <x-inputs.maskable mask="['(###) ###-####', '+# ### ###-####', '+## ## ####-####']"
                    wire:model.defer="data.whatsapp" label="WhatsApp (DDD) XXXX-XXXX" placeholder="(DDD) XXXX-XXXX" />
                </div>
                <div class="md:col-span-6">
                    <x-input  wire:model.defer="data.email" class="pr-28" label="E-mail" placeholder="E-mail" suffix="@mail.com" />
                </div>
