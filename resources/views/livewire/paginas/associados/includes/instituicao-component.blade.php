        ...
        <form wire:submit.prevent="save" class="lg:col-span-2">
            ...
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
                ...
                <div class="md:col-span-4">
                    <x-input wire:model.defer="data.fantasy_name" label="Nome Fantasia" placeholder="Nome Fantasia" />
                </div>
                ...
                <div class="md:col-span-1">
                    <x-input wire:model.defer="data.address.state" label="UF / Estado" placeholder="UF / Estado" />
                </div>
