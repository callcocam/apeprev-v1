<li class="hoverable hover:bg-teal-700 hover:text-white">
    <a href="#"
        class="relative flex w-full py-4 px-4 lg:p-4 text-sm lg:text-base font-bold hover:bg-teal-700 hover:text-white">
        {{ data_get($menu, 'Hoverable') }}
    </a>
    <div class="p-6 mega-menu mb-16 sm:mb-0 shadow-xl bg-teal-700  z-30">
        <div class="container md:mx-auto w-full flex flex-wrap justify-between mx-2">
            ...
            <ul
                ...
                <p class="text-gray-100 text-sm">Thul klivian doldur thisspiasian calrissian. Garindan d8
                    aurra twi'lek tund polis gen'dai sola tarpals.</p>
                <div class="flex items-center py-3">
                    <svg class="h-6 pr-3 fill-current text-teal-300" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 20 20">
                        <path
                            d="M20 10a10 10 0 1 1-20 0 10 10 0 0 1 20 0zm-2 0a8 8 0 1 0-16 0 8 8 0 0 0 16 0zm-8 2H5V8h5V5l5 5-5 5v-3z" />
                    </svg>
                    <a href="" class="text-white bold border-b-2 border-teal-300 hover:text-teal-900">Find
                        out more...</a>
                </div>
            </ul>
            <ul
