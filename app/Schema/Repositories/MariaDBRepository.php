...
namespace App\Schema\Repositories;

use Illuminate\Support\Facades\DB;
use App\Schema\Repositories\Entities\MariaDB\CheckConstraint;
...
class MariaDBRepository extends Repository
{
     ...
     * @return \App\Schema\Repositories\Entities\MariaDB\CheckConstraint|null
     */
