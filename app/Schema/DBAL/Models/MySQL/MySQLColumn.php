...
use App\Schema\DBAL\Models\DBALColumn;
use App\Schema\Models\Enum\Migrations\Method\ColumnType;
use App\Schema\Repositories\MariaDBRepository;
use App\Schema\Repositories\MySQLRepository;
use App\Schema\Support\CheckMigrationMethod;
use PDO;
...
class MySQLColumn extends DBALColumn
{
    ...
    /**
     * @var \App\Schema\Repositories\MySQLRepository
     */
    private $repository;

    /**
     * @var \App\Schema\Repositories\MariaDBRepository
     */
