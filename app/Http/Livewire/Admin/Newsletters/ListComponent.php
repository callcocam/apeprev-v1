...
final class ListComponent extends TableComponent
{
    ...
    */
    ...
    public function route(){
        Route::get('/newsletters', static::class)->name('admin.newsletters');
    }
    ...
    */
    protected function actions(){
        ...
        return [
           // Link::make('Edit')->route('admin.newsletter.edit')->xs()->icon('pencil-alt')->primary(),
    ...
    */
    protected function columns(){
        return [
            Column::make('Email')->searchable()->sortable()->makeInputText('name'),
