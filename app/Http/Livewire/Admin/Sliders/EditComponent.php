...
class EditComponent extends FormComponent
{
  ...
  use AuthorizesRequests;
    ...
    */
    ...
    {
        $this->data['end_date'] = date_carbom_format(data_get($this->data,'end_date'))->format("Y-m-d");
        $this->data['start_date'] = date_carbom_format(data_get($this->data,'start_date'))->format("Y-m-d");
    ...
    */
    protected function fields(): array
    {
        return [
            ...
            DatetimePicker::make('Data Inicio','start_date')->without_time()->span('6')->rules('required'),
            DatetimePicker::make('Data Fim','end_date')->without_time()->span('6')->rules('required'),
