...
final class ListComponent extends TableComponent
{
    ...
    */
    ...
    public function route(){
        Route::get('/eventos-configuracaos', static::class)->name('admin.eventos-configuracaos');
    }
    ...
    */
    ...
    {
        return 'admin.eventos-configuracao.create';
    }
    ...
    */
    protected function query(){
        return EventosConfiguracao::query();
    }
    ...
    */
    ...
    {
        return [
           'tableTitle' => __('EventosConfiguracaos'),
       ];
    }
    /*
    |--------------------------------------------------------------------------
    ...
    */
    protected function actions(){
        ...
        return [
            Link::make('Edit')->route('admin.eventosconfiguracao.edit')->xs()->icon('pencil-alt')->primary(),
