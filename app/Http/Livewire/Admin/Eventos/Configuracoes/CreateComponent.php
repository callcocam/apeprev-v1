...
class CreateComponent extends FormComponent
{
    ...
    */
    public function route(){
        Route::get('/eventos-configuracao/create', static::class)->name('admin.eventos-configuracao.create');
    }
    ...
    */
    ...
    {
          return redirect()->route("admin.eventos-configuracao.edit", $this->model);
    }
