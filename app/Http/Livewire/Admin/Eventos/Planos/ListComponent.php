...
final class ListComponent extends TableComponent
{
    ...
    */
    ...
    public function route(){
        Route::get('/evento/planos', static::class)->name('admin.evento-planos');
    }
    ...
    */
    ...
    {
        return 'admin.evento-plano.create';
    }
    ...
    */
    protected function actions(){
        ...
        return [
            Link::make('Edit')->route('admin.evento-plano.edit')->xs()->icon('pencil-alt')->primary(),
