...
class EditComponent extends FormComponent
{
    ...
    */
    public function route(){
        Route::get('/evento/plano/{model}/edit', static::class)->name('admin.evento-plano.edit');
    }
    ...
    */
    protected function fields(): array
    {
        return [
            ...
            Checkbox::make('Tipo de instituição', 'instituicao_tipo')->options(\App\Models\InstituicaoTipo::query()->pluck("name",'id')->toArray())->rules('required'),
    ...
    */
    ...
    {
          return redirect()->route("admin.evento-planos");
    }
