...
final class ListComponent extends TableComponent
{
    ...
    */
    ...
    public function route(){
        Route::get('/palestras', static::class)->name('admin.palestras');
    }
    ...
    */
    protected function actions(){
        ...
        return [
            Link::make('Edit')->route('admin.palestra.edit')->xs()->icon('pencil-alt')->primary(),
