...
class CreateComponent extends FormComponent
{
    ...
    */
    protected function fields(): array
    {
        return [
            ...
            Currency::make('Valor single','valor_single'),
            Currency::make('Valor duble','valor_duble'),
            Currency::make('Valor triple','valor_triple'),
    ...
    */
    ...
    {
          return redirect()->route("admin.hotel.edit", $this->model);
    }
