...
final class ListComponent extends TableComponent
{
    ...
    */
    ...
    public function route(){
        Route::get('/locals', static::class)->name('admin.locals');
    }

    public function getCreateProperty()
    {
        return 'admin.local.create';
    }
    /*
    |--------------------------------------------------------------------------
    |  Features query
    ...
    */
    protected function actions(){
        ...
        return [
            Link::make('Edit')->route('admin.local.edit')->xs()->icon('pencil-alt')->primary(),
