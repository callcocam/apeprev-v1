...
final class ListComponent extends TableComponent
{
    ...
    */
    ...
    public function route(){
        Route::get('/instituicoes/planos', static::class)->name('admin.instituicoes.planos');
    }
    ...
    */
    protected function query(){
        return InstituicoesPlano::query();
    }
    ...
    */
    protected function actions(){
        ...
        return [
            Link::make('Edit')->route('admin.instituicoes.plano.edit')->xs()->icon('pencil-alt')->primary(),
