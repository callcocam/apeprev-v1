...
*/
namespace App\Http\Livewire\Admin\Instituicoes\Servidores;
...
final class ListComponent extends TableComponent
{
    ...
    */
    ...
    public function route(){
        Route::get('/servidors', static::class)->name('admin.servidors');
    }
    ...
    */
    protected function actions(){
        ...
        return [
            Link::make('Edit')->route('admin.servidor.edit')->xs()->icon('pencil-alt')->primary(),
