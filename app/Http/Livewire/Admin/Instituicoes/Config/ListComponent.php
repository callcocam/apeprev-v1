...
final class ListComponent extends TableComponent
{
    ...
    */
    ...
    public function route(){
        Route::get('/instituicao/configs', static::class)->name('admin.instituicao-configs');
    }
    ...
    */
    protected function query(){
        return InstituicaoConfig::query();
    }
    ...
    */
    ...
    {
        return [
           'tableTitle' => __('InstituicaoConfigs'),
       ];
    }
    /*
    |--------------------------------------------------------------------------
    ...
    */
    protected function actions(){
        ...
        return [
            Link::make('Edit')->route('admin.instituicao-config.edit')->xs()->icon('pencil-alt')->primary(),
