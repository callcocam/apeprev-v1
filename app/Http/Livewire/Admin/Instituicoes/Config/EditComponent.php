...
class EditComponent extends FormComponent
{
    ...
    */
    public function route(){
        Route::get('/instituicao-config/{model}/edit', static::class)->name('admin.instituicao-config.edit');
    }
    ...
    */
    ...
    {
        return [
           'formTitle' => __('InstituicaoConfig'),
           'formAction' => __('Edit'),
           'wrapWithView' => false,
           'showDelete' => false,
       ];
    ...
    */
    ...
    {
          return redirect()->route("admin.instituicao-configs");
    }
