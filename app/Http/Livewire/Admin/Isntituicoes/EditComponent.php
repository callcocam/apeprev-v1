...
class EditComponent extends FormComponent
{
    ...
    */
    ...
    {
        return [
            Divider::blank("Dados da Instituição")->hint('Preencha corretamente todos os campos'),
            ...
            Divider::blank("Quantidade de Servidores")->hint('Preencha corretamente todos os campos'),
            ...
            Divider::blank("Dados do Representante")->hint('Preencha corretamente todos os campos'),
