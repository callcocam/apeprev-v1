...
final class ListComponent extends TableComponent
{
    ...
    */
    ...
    {
        return 'admin.representante.create';
    }
     /*
    |--------------------------------------------------------------------------
    |  Features route
    ...
    */
    ...
    public function route(){
        Route::get('/representantes', static::class)->name('admin.representantes');
    }
    ...
    */
    protected function actions(){
        ...
        return [
            Link::make('Edit')->route('admin.representante.edit')->xs()->icon('pencil-alt')->primary(),
