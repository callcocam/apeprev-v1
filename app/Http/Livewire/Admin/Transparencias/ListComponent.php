...
final class ListComponent extends TableComponent
{
    ...
    */
    ...
    public function route(){
        Route::get('/transparencias', static::class)->name('admin.transparencias');
    }
    ...
    */
    protected function actions(){
        ...
        return [
            Link::make('Edit')->route('admin.transparencia.edit')->xs()->icon('pencil-alt')->primary(),
