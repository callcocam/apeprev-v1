...
final class ListComponent extends TableComponent
{
    ...
    {
        return 'admin.transparencias.detalhe.create';
    }
     /*
    |--------------------------------------------------------------------------
    |  Features route
    ...
    */
    ...
    public function route(){
        Route::get('/transparencias/detalhes', static::class)->name('admin.transparencias.detalhes');
    }
    ...
    */
    public function format_view(){
        return "admin.transparencias.detalhes";
     }
    /*
    |--------------------------------------------------------------------------
    |  Features query
    ...
    */
    protected function actions(){
        ...
        return [
            Link::make('Edit')->route('admin.transparencias.detalhe.edit')->xs()->icon('pencil-alt')->primary(),
